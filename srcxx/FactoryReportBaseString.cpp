...
QString
FactoryReportBaseString::getBaseString(const char* p_templateName, const QString& p_writer, const QString& p_delimiter) const
{
	QString path ;
...
QString
FactoryReportBaseString::getCSString() const
{
