...
int
ModelSngAnalysisErrors::columnCount(const QModelIndex & /*parent*/) const
{
	return(COL_HEADERS.count()) ;
}

int
ModelSngAnalysisErrors::rowCount(const QModelIndex & /*parent*/) const
{
...
QVariant
ModelSngAnalysisErrors::data(const QModelIndex &index, int role) const
{
	QVariant retVal ;
...
QVariant
ModelSngAnalysisErrors::headerData(int section, Qt::Orientation orientation, int role) const
{
	if (role == Qt::DisplayRole)
	{
...
QModelIndex
ModelSngAnalysisErrors::index(int row, int column, const QModelIndex & /*parent*/) const
{
...
QModelIndex
ModelSngAnalysisErrors::parent(const QModelIndex & /*index*/) const
{
	return(QModelIndex()) ;
}
...
void
ModelSngAnalysisErrors::addError(const AnalysisError& e)
{
	__errors.append(e) ;
...
void
ModelSngAnalysisErrors::addErrors(const QVector<AnalysisError>& ve)
{
	__errors.append(ve) ;
...
int
ModelSngAnalysisErrors::getNberrorsInAFile(const QString& p_fileId)
{
...
void
ModelSngAnalysisErrors::refresh()
{
...
const QString
ModelSngAnalysisErrors::getReportErrorSummaryTable(const QString& p_writer, const QString& p_delimiter) const
{
